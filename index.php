...
<body>
    <img src="bg.jpg" alt="DY Patil Pimpri" class="bg">
    <div class="container">
        <h1>Welcome to Japan Tour Form.</h1>
        <p>Enter your details and submit it to confirm your seat.</p>
        
        <?php
            if($insert==true){
            echo "<p class='submitMsg'>Thanks for submitting this form. We are happy to see you joining us for Japan trip.</p>";
            }
        ?>
